...
pub struct QuestionsBackendSettings {
    pub(crate) image_config: Config,
}

impl QuestionsBackendSettings {
    pub fn new(image_config: Config) -> Self {
        Self { image_config }
    }
}

impl Default for QuestionsBackendSettings {
    fn default() -> Self {
        Self {
...
impl Debug for QuestionsBackendSettings {
...
impl Clone for QuestionsBackendSettings {
    fn clone(&self) -> Self {
        Self {
